...
public class GameRunner {
    ...
    public void placePlayers(){
        ...
        for (int i = 0; i < 4; i++) {
            ...
            playSpace.getCurrentRoom(curLoc).addCreature(ob); // add orbiter to board
            ...
            playSpace.getCurrentRoom(curLoc).addCreature(sk); // add Seeker to board
            ...
            playSpace.getCurrentRoom(curLoc).addCreature(bk); // add Blinker to board
    ...
    public void creatureAction() { //creature action
        for (int i = 0; i < aliveCreatures.size(); i++) {
            ...
            curRoom = curCre.board.getCurrentRoom(curCre.location); //get new location
            if(curRoom.checkForAdventurer()) {
    ...
    public void adventurerAction() {
        for (int i = 0; i < aliveAdventurers.size(); i++) { //check for alive adventurers
            ...
            Room curRoom = curAdv.board.getCurrentRoom(curAdv.location);
    ...
    public Boolean gameOver() {
        ...
        for (int i=0; i < aliveAdventurers.size(); i++) {
            totalT += aliveAdventurers.get(i).treasure;
        }
